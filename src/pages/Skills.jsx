...
const ROWS = [
  [
    ...
    { title: "AI/ML Skills", items: ["TensorFlow", "Machine Learning", "Deep Learning", "NLP & Data Preprocessing", "Model Training & Hyperparameter Tuning"] },
    { title: "Data Science & Analytics", items: ["Pandas", "NumPy", "Matplotlib", "Power BI", "Excel", "Exploratory Data Analysis (EDA)", "Data Visualization"] },
  ],
  [
    {
      title: "Frontend & Design",
      items: ["React (Basic)", "UI/UX Design", "Figma", "Responsive Design"],
    },
    {
      title: "Tools & Version Control",
      items: ["Git", "GitHub", "Presentation Design", "Dashboard Creation"],
    },
    {
      title: "Learning Focus",
      items: ["Transformers & LLMs", "Full-stack ML Deployment (Flask + React)", "AI Chatbot Integration"],
    },
  ],
];
    ...
    <section className="skills-container" id="skills">
      ...
      <motion.div
        ...
        style={{
          ...
          overflow: "hidden",
          boxShadow: "inset 0 0 60px rgba(0,123,255,0.07)",
          position: "relative",
        }}
      >
        {SKILLS.map((s, i) => (
          <motion.div
            ...
            whileHover={{
              scale: 1.3,
              boxShadow: "0 0 35px 10px rgba(0,123,255,0.6)",
          ...
          >
            <motion.img
              ...
              style={{
                ...
                height: "50px",
                objectFit: "contain",
                filter: "drop-shadow(0 0 8px rgba(0,123,255,0.4)) brightness(1.2)",
                marginBottom: "5px",
              }}
              whileHover={{
                filter: "drop-shadow(0 0 12px rgba(0,123,255,0.9)) brightness(1.6)",
                rotate: [0, 6, -6, 0],
