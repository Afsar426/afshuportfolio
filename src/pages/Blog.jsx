  ...
  const defaultPosts = [
    {
      ...
      text: "Working on AI-based systems like MyMoneyMentor-AI and GreenLoop has taught me how impactful technology can be when applied to real-world problems. Combining data science with innovative solutions is my passion.",
    },
    {
      id: 2,
      title: "My Thoughts on Design & Aesthetics",
      text: "I believe design should be a balance between functionality and emotion. Blue-white themes with clean layouts inspire me to create something that feels modern and accessible.",
    },
    {
      id: 3,
      title: "Balancing Tech and Creativity",
      text: "As an AI developer, I’ve realized creativity isn’t limited to art — it also lives in algorithms. Each project is like crafting intelligent solutions for everyday challenges.",
    },
    {
      id: 4,
